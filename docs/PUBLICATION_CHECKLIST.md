...
- Confirm README first paragraph includes Australian tax prep, official ATO source-linked wording, GST/BAS, CGT, accountant handoff, and supported agent surfaces.
