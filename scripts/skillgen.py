...
def writeOutputLayers(root: str) -> None:
    for slug in ["workbook", "taxpack"]:
        ...
        body += "- Preserve valid falsey output values such as numeric `0` and boolean `false`.\n"
        body += "- Review-feedback fixes must cover parsed input and direct renderer/workbook-row paths before another review is requested.\n"
