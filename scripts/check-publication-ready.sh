...
for (const term of ["ATO source-linked Australian tax prep", "GST/BAS", "CGT", "accountant-ready", "Codex", "Claude Code", "Cowork"]) {
...
if (!plugin.interface.shortDescription.includes("ATO source-linked Australian tax prep skills")) fail("plugin short description missing discovery copy");
