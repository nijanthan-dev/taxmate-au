    ...
    findings.extend(
        fail_if_missing(
            ...
            [
                ...
                "investment_has_reconciliation_target(answers, interest_items, dividend_items, distribution_items)",
