...
<div class="steps" data-anchor="how-to-row"><div class="step"><b>1. Review answers</b><p>Check each value against your records.</p></div><div class="step"><b>2. Follow ATO labels</b><p>Use ATO label references to find where each answer belongs.</p></div><div class="step"><b>3. Clear red flags</b><p>Ask an accountant about every Review item.</p></div><div class="step"><b>4. Copy manually</b><p>Enter reviewed answers into myTax or paper form.</p></div></div>
