...
description: Entry-point wrapper for TaxMate Australia's full ATO source-linked tax prep workflow across research, review, calculators, and handoff outputs. Use when a local helper must route general TaxMate requests into the full runtime.
