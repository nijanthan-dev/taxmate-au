...
- If reviewed output fields conflict, preserve the most conservative state: `Accountant review` overrides stale evidence, used, ATO-label, skipped, status-kind, tab-kind, or styling fields.
