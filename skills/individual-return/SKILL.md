...
description: Guide V1 Australian individual tax return intake, including PAYG, sole-trader ABN, BAS worksheet, WFH, assets, spouse, dependants, and HTML handoff. Use when the user wants an individual return prep pack or a broad individual tax checklist.
...
Do not fully handle company, trust, partnership, full supplementary, rental property, full CGT, crypto CGT, foreign income, ESS, ETP, lump sum, PSI deep, or advanced OCR/template extraction workflows. Detect and route those topics to the most specific installed skill or mark `Accountant review`.
