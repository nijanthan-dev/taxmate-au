...
- Review-feedback fixes must cover parsed input, file-backed data, direct renderer/workbook-row paths, generated artifacts, tests, validator, and docs/skills/AGENTS guardrails before another review is requested.
